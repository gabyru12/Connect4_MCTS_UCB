...
def user_first_vs_AI(c_constant_mcts: float, iterations: int, reset: bool, drawValue: float, showMCTSTime: bool, showNodesStats: bool):
    ...
    while True:
        ...
        if connect4.checkPlayerWon(connect4.lastMovementRow, connect4.lastMovementCol, "O"):
            connect4.printState()
            print("You win")
            break
        ...
        if connect4.checkPlayerWon(connect4.lastMovementRow, connect4.lastMovementCol, "X"):
            connect4.printState()
            print("AI win")
            break
        elif connect4.checkTie():
