...
class Connect4:
    ...
    def checkPlayerWon(self, row: int, col: int, player: str) -> bool:
        # Horizontal
    ...
    def checkGameOver(self) -> bool:
        return self.checkPlayerWon(self.lastMovementRow, self.lastMovementCol, "O") or self.checkPlayerWon(self.lastMovementRow, self.lastMovementCol, "X") or self.checkTie()

    def checkGameResult(self):
        if self.checkTie():
            return "-"
        elif self.checkPlayerWon(self.lastMovementRow, self.lastMovementCol, "O"):
            return "O"
        else:
            return "X"
